...
//   2. chatLimiter   — enforces rate limit on chat Q&A requests
//   3. askQuestion   — runs full RAG pipeline, returns answer + sources + chunks
//
router.post('/ask', authenticate, chatLimiter, askQuestion);
