          ...
          <div className="max-w-container-max mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                <a href="https://github.com/SkanxGladiatorr07/DocuSense-RAG-ChatBot" target="_blank" rel="noopener noreferrer" className="px-8 py-3 bg-zinc-900 border border-zinc-700 text-[#2da44e] font-title-md text-title-md rounded-xl hover:bg-zinc-800 transition-all active:scale-[0.98] flex items-center gap-2 shadow-lg shadow-zinc-900/20">
        ...
        <div className="max-w-container-max mx-auto grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4 font-body-md text-body-md text-secondary">
              ...
              <li><Link className="hover:text-primary transition-colors" to="/dashboard?view=help">Security</Link></li>
